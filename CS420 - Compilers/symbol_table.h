...
public:	
  ...
  */
  ...
  /* Gets the type of the formal parameter in the indicated position */
  ...
  // gets the number or elements in the symbol table
  int get_size();

  // gets the id of an element at a position
  string *get_id_at_position(int pos);

  //checks if the element at a position is an int or bool
  bool is_intbool_at_position(int pos);
